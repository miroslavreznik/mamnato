...
export default function StepNavigation({
  ...
  return (
    <div className="sticky bottom-0 z-10 -mx-6 sm:-mx-8 mt-8 px-6 sm:px-8 py-4 bg-white/90 dark:bg-gray-800/90 backdrop-blur border-t border-line flex justify-between items-center gap-3 rounded-b-2xl">
      {showBack ? (
        <button
          type="button"
          onClick={onBack}
          className="inline-flex items-center gap-1.5 px-5 py-2.5 text-ink-body rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors min-h-[44px] font-medium"
        >
